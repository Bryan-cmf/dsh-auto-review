// dsh-auto-review — client half (v1.4.0).
//
	...
	factory: (require) => {
		...
		function DimCard(props) {
			...
			return e("div", { style: { background: cBg1, border: "1px solid " + cBorder, borderRadius: 10, padding: "8px 12px", marginBottom: 6 } },
				...
				dim.error ? e("div", { style: { color: cBad, fontSize: 12, marginTop: 4 } }, "⚠ " + dim.error) : null,
				open && (findings.length || ignored.length) ? e("div", { style: { marginTop: 8, borderTop: "1px solid " + cBorder, paddingTop: 8 } },
					findings.map(function (f, i) {
						// P1-7：severity 豎條色標 + title/detail/suggestion 分行留白 + 緊湊排版
						const sev = SEV_COLOR[f.severity] || cMuted;
						return e("div", { key: i, style: { borderLeft: "3px solid " + sev, paddingLeft: 10, marginBottom: 6 } },
							e("div", { style: { display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" } },
								e("span", { style: { color: sev, fontWeight: 700, fontSize: 11 } }, f.severity),
								e("span", { style: { color: cMuted, fontFamily: mono, fontSize: 11 } }, f.file + (f.line != null ? ":" + f.line : ""))),
							e("div", { style: { color: cText, fontSize: 12, marginTop: 2, lineHeight: 1.45 } }, f.title),
							f.detail ? e("div", { style: { color: cMuted, fontSize: 12, marginTop: 2, lineHeight: 1.45 } }, f.detail) : null,
							f.suggestion ? e("div", { style: { color: cBrand, fontSize: 12, marginTop: 2, lineHeight: 1.45 } }, "→ " + f.suggestion) : null);
					}),
					ignored.length ? e("div", { style: { marginTop: findings.length ? 6 : 0, paddingTop: 6, borderTop: "1px dashed " + cBorder } },
						...
						ignored.map(function (f, i) {
							const sev = SEV_COLOR[f.severity] || cMuted;
							return e("div", { key: "ig" + i, style: { borderLeft: "3px solid " + sev, paddingLeft: 8, marginBottom: 4, opacity: 0.85 } },
								e("div", { style: { display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap" } },
									e("span", { style: { color: sev, fontWeight: 700, fontSize: 11 } }, f.severity),
									e("span", { style: { color: cMuted, fontFamily: mono, fontSize: 11 } }, f.file + (f.line != null ? ":" + f.line : ""))),
								e("div", { style: { color: cMuted, fontSize: 12, marginTop: 2 } }, f.title),
								f.ignorePattern ? e("div", { style: { color: cMuted, fontSize: 11, marginTop: 2 } },
									"命中：" + f.ignorePattern + (f.ignoreReason ? "（理由：" + f.ignoreReason + "）" : "")) : null);
						})) : null,
				) : null,
			);
		}
		...
		function ModelOrderEditor(props) {
			...
			const mini = {
				...
				padding: "0 6px", fontSize: 11, cursor: "pointer", fontFamily: "inherit", lineHeight: "18px",
			};
			if (order.length === 0) {
				...
				e("div", { style: { display: "flex", flexWrap: "wrap", gap: 6 } },
					order.map(function (key, idx) {
						return e("span", { key: key, style: { display: "inline-flex", alignItems: "center", gap: 4, border: "1px solid " + cBorder2, borderRadius: 999, padding: "2px 8px", fontSize: 12, color: cText } },
							...
							e("button", { style: Object.assign({}, mini, { color: cBad, borderColor: cBad }), title: "取消選用", onClick: function () { props.onRemove(key); } }, "✕"));
					})),
		...
		function InjItemRow(props) {
			...
			return e("div", { style: { display: "flex", alignItems: "baseline", gap: 8, flexWrap: "wrap", borderLeft: "3px solid " + sev, paddingLeft: 8, padding: "3px 0", marginBottom: 4 } },
